...
export const TurfBookingFlow: React.FC<TurfBookingFlowProps> = ({
  ...
  const [slots, setSlots] = useState<
    Array<TimeSlot & { currentStatus: 'উপলব্ধ' | 'বুকড' | 'অপেক্ষমাণ' | 'লকড' | 'বন্ধ' }>
  >([]);
  ...
  const [couponStatusMessage, setCouponStatusMessage] = useState<{ type: 'success' | 'error'; msg: string } | null>(
    null,
  );
      ...
      {confirmedBooking ? (
        <div className='bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-10 space-y-8'>
          ...
          <div className='text-center space-y-3 pb-6 border-b border-gray-100'>
            ...
            <h2 className='text-2xl sm:text-3xl font-black text-gray-950'>আপনার বুকিং সফলভাবে সম্পন্ন হয়েছে!</h2>
                    ...
                    {filteredSlots.map((slot) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className='text-sm sm:text-base font-bold my-0.5'>{slot.startTime}</span>
                          <span className='text-xs'>{slot.endTime} পর্যন্ত</span>

                          <div
                            className={`mt-2 pt-1 border-t w-full text-xs font-bold ${isSelected ? 'border-red-400 text-white' : 'border-gray-100 text-red-600'}`}
                          >
              ...
              <form onSubmit={handleSubmitBooking} className='space-y-6'>
                ...
                <div className='bg-white p-6 rounded-2xl shadow-sm border border-gray-200 space-y-4'>
                  ...
                  <div className='space-y-1.5'>
                    ...
                    {couponStatusMessage && (
                      <p
                        className={`text-xs font-semibold ${couponStatusMessage.type === 'success' ? 'text-emerald-600' : 'text-red-600'}`}
                      >
                      ...
                      {paymentMethod === 'বিকাশ' && (
                        <div>
                          ...
                          <div className='text-gray-600'>
                            ...
                            <span className='font-bold text-red-600 font-mono text-sm'>{settings?.bkashNumber}</span>
                          </div>
                      ...
                      {paymentMethod === 'নগদ' && (
                        <div>
                          ...
                          <div className='text-gray-600'>
                            ...
                            <span className='font-bold text-red-600 font-mono text-sm'>{settings?.nagadNumber}</span>
                          </div>
                          <div className='text-gray-500 text-2xs mt-1'>
                      ...
                      {paymentMethod === 'রকেট' && (
                        <div>
                          ...
                          <div className='text-gray-600'>
                            ...
                            <span className='font-bold text-red-600 font-mono text-sm'>{settings?.rocketNumber}</span>
                          </div>
                        </div>
                      )}
                  ...
                  <div className='p-4 bg-gray-50 rounded-xl space-y-2 text-xs border border-gray-200'>
                    ...
                    <div className='flex justify-between text-gray-600'>
                      ...
                      <span className='font-bold text-gray-900'>৳{selectedSlot ? selectedSlot.regularPrice : 0}</span>
                    </div>
                    ...
                    <div className='pt-2 border-t border-gray-200 flex justify-between items-center text-sm font-black text-gray-950'>
                      ...
                      <span className='text-lg text-red-600 font-bold'>৳{calculateFinalTotal()}</span>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start space-x-2 pt-1'>
                    ...
                    >
                      ...
                      <span className='font-bold text-red-600 underline'>নিয়ম ও শর্তাবলি</span> এবং বাতিল নীতিমালা
                      (কমপক্ষে ৩ দিন পূর্বে অবহিতকরণ) মেনে নিচ্ছি।
                    </label>
                  </div>
