...
import { MapPin, Phone, Mail, MessageCircle, ExternalLink, Send, Clock, CheckCircle2 } from 'lucide-react';
    ...
    <section id='contact' className='py-20 bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center max-w-3xl mx-auto mb-16 space-y-3'>
          ...
          <h2 className='text-3xl sm:text-4xl font-black text-gray-950'>আমাদের সাথে যোগাযোগ করুন</h2>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-10'>
          ...
          <div className='lg:col-span-5 space-y-6'>
            ...
            <div className='bg-gray-50 p-6 rounded-2xl border border-gray-200 space-y-4'>
              <h3 className='text-lg font-bold text-gray-950'>টমছম ব্রিজ টার্ফ ও কিডস জোন</h3>
          ...
          <div className='lg:col-span-7 space-y-6'>
            ...
            {/* Quick Inquiry Form */}
            <div className='bg-gray-50 p-6 rounded-2xl border border-gray-200 space-y-4'>
              <h3 className='text-base font-bold text-gray-950'>আমাদের সরাসরি মেসেজ পাঠান</h3>
