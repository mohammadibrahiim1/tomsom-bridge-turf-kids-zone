...
export const PrintableReceipt: React.FC<PrintableReceiptProps> = ({
  ...
  const handleDownloadPDF = () => {
    try {
      ...
      const headerSubtitle = settings.receiptHeaderSubtitle || settings.addressEn || 'Madhya Ashrafpur, Mazar Gate (Near Tomsom Bridge), Cumilla';
      ...
      doc.text(`Date of Issue: ${new Date(booking.createdAt).toLocaleDateString()}`, 190, 58, { align: 'right' });
      ...
      if (booking.discountAmount > 0) {
        ...
        doc.text(`- Tk. ${booking.discountAmount}`, 185, 128, { align: 'right' });
      }
      ...
      const rulesToUse = (settings.receiptFooterRules && settings.receiptFooterRules.length > 0)
      ...
      doc.text(settings.receiptFooterNote || 'Thank you for choosing Tomsom Bridge Turf & Kids Zone. Enjoy your match!', 105, 280, { align: 'center' });
...
সময় স্লট: ${booking.slotTime} (${booking.slotDuration})
গ্রাহকের নাম: ${booking.customerName}
মোবাইল: ${booking.customerPhone}
মোট ভাড়া: ৳${booking.totalAmount}
...
মোবাইল: ${booking.customerPhone}
মোট প্রদেয়: ৳${booking.totalAmount} (${booking.paymentStatus})
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-6 no-print border-b pb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            title="মেমো কপি করুন"
          >
            {isCopied ? <Check className="w-3.5 h-3.5 mr-1 text-emerald-600" /> : <Copy className="w-3.5 h-3.5 mr-1 text-gray-600" />}
      ...
      <div className="space-y-6 text-gray-900">
        ...
        <div className="grid grid-cols-2 bg-gray-50 p-3.5 rounded-xl border border-gray-200 text-xs">
          ...
          <div className="text-right">
            <span className="text-gray-500 block font-medium">ইস্যুর তারিখ ও সময়:</span>
            ...
            <tbody className="divide-y divide-gray-200">
              <tr>
                <td className="p-3 font-semibold text-gray-900">
                  টার্ফ গ্রাউন্ড ভাড়া ({booking.slotTime})
                </td>
              ...
              {booking.discountAmount > 0 && (
                <tr className="bg-emerald-50 text-emerald-800">
                  <td className="p-3 font-semibold">
                    কুপন ডিসকাউন্ট ({booking.couponCode || 'PROMO'})
                  </td>
                  <td className="p-3 text-center">-</td>
                  <td className="p-3 text-right font-bold">- ৳{booking.discountAmount}</td>
                </tr>
              )}
              <tr className="bg-gray-100 font-bold text-sm text-gray-950">
                <td colSpan={2} className="p-3 text-right">সর্বমোট প্রদেয়:</td>
                <td className="p-3 text-right text-red-600 font-black text-base">
                  ৳{booking.totalAmount}
                </td>
              </tr>
            </tbody>
          ...
          <ul className="list-disc list-inside space-y-0.5 text-gray-600">
            {(settings.receiptFooterRules && settings.receiptFooterRules.length > 0) ? (
              ...
              <>
                ...
                <li>টার্ফে অবশ্যই উপযুক্ত টার্ফ বুট অথবা সাধারণ স্নিকার্স পরতে হবে। ব্লেড বুট/খালি পায়ে খেলা নিষিদ্ধ।</li>
        ...
        <div className="pt-6 flex justify-between items-end text-xs">
          <div className="flex items-center space-x-2 text-gray-400">
            ...
            <span className="text-3xs leading-tight text-gray-600">
              অনলাইন ভেরিফায়েড বুকিং<br />{settings.websiteNameBn || 'টমছম ব্রিজ টার্ফ'}
            </span>
          </div>
