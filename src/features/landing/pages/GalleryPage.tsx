...
import { Camera, Sparkles, Image as ImageIcon, Video, CalendarCheck, Share2 } from 'lucide-react';
...
export const GalleryPage: React.FC<GalleryPageProps> = ({ settings, gallery, onNavigate, onOpenBooking }) => {
  return (
