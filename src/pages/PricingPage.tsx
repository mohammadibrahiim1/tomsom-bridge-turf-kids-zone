      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gray-50 rounded-3xl p-8 border border-gray-200 space-y-4">
          ...
          <ul className="space-y-2 text-xs text-gray-600 list-disc list-inside leading-relaxed">
            ...
            <li>ম্যাচ শুরুর অন্তত ৬ ঘণ্টা পূর্বে বুকিং বাতিল করলে সম্পূর্ণ টাকা রিফান্ড বা অন্য দিনে রিশিডিউল করা সম্ভব।</li>
            <li>প্রাকৃতিক দুর্যোগ বা প্রচণ্ড বৃষ্টির কারণে খেলা অসম্ভব হলে সম্পূর্ণ রিফান্ড বা বিকল্প স্লট দেওয়া হবে।</li>
