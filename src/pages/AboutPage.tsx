...
export const AboutPage: React.FC<AboutPageProps> = ({ settings, turfInfo, facilities, onNavigate, onOpenBooking }) => {
  return (
        ...
        <div className='bg-white rounded-3xl p-8 border border-gray-200 shadow-sm space-y-8'>
          <div className='border-b border-gray-100 pb-6'>
            <h2 className='text-2xl font-black text-gray-900 flex items-center'>
              ...
              টার্ফের বিশেষ সুবিধাসমূহ ও স্পেসিফিকেশন
            </h2>
            <p className='text-sm text-gray-600 mt-1'>
              খেলোয়াড়দের স্বাচ্ছন্দ্য ও নিরাপত্তার দিকে শতভাগ নজর দিয়ে টার্ফটি প্রস্তুত করা হয়েছে।
            </p>
          </div>

          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            <div className='p-5 bg-gray-50 rounded-2xl border border-gray-200'>
              <div className='text-xs text-red-600 font-bold uppercase mb-1'>ফিফা গ্রাস কোয়ালিটি</div>
              <div className='text-lg font-black text-gray-900 mb-2'>{turfInfo.grassType}</div>
              <p className='text-xs text-gray-600'>
                ৫০ মিমি হাই-ডেনসিটি ফাইবার যা প্রাকৃতিক ঘাসের অনুভূতি দেয় ও পড়ে গেলে আঘাত লাগার ঝুঁকি কমায়।
              </p>
            </div>

            <div className='p-5 bg-gray-50 rounded-2xl border border-gray-200'>
              <div className='text-xs text-red-600 font-bold uppercase mb-1'>মাঠের পরিমাপ</div>
              <div className='text-lg font-black text-gray-900 mb-2'>{turfInfo.size}</div>
              <p className='text-xs text-gray-600'>
                ৭-এ-সাইড ও ৮-এ-সাইড ফুটবল এবং শর্ট বাউন্ডারি বক্স ক্রিকেটের জন্য আইডিয়াল ফিল্ড।
              </p>
            </div>

            <div className='p-5 bg-gray-50 rounded-2xl border border-gray-200'>
              <div className='text-xs text-red-600 font-bold uppercase mb-1'>ফ্লাডলাইট ও নাইট ম্যাচ</div>
              <div className='text-lg font-black text-gray-900 mb-2'>{turfInfo.floodlights}</div>
              <p className='text-xs text-gray-600'>
                হাই-লুমেন অ্যান্টি-গ্লেয়ার এলইডি লাইট এবং সার্বক্ষণিক স্ট্যান্ডবাই জেনারেটর ব্যাকআপ।
              </p>
            </div>

            <div className='p-5 bg-gray-50 rounded-2xl border border-gray-200'>
              <div className='text-xs text-red-600 font-bold uppercase mb-1'>সময়সূচি ও সার্ভিস</div>
              <div className='text-lg font-black text-gray-900 mb-2'>{turfInfo.openingHours}</div>
              <p className='text-xs text-gray-600'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='bg-red-600 rounded-3xl p-8 sm:p-10 text-white text-center flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl'>
          <div className='text-left space-y-1'>
            ...
            <p className='text-red-100 text-sm'>অনলাইনে সরাসরি স্লট বুক করে আপনার খেলার সময় নির্ধারণ করুন।</p>
          </div>
          <button
