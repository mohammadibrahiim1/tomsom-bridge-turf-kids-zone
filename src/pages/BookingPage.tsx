        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-xs">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              স্লট নিশ্চিত করতে ন্যূনতম ৫০০ টাকা বা পূর্ণ ফি বিকাশ/নগদে সেন্ড মানি করে ট্রানজাকশন আইডি ও নম্বর প্রদান করুন।
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-xs">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              বুকিং সংক্রান্ত যেকোনো প্রশ্নে আমাদের সরাসরি কল করতে পারেন: <strong className="text-red-600">{settings.phone}</strong>
            </p>
          </div>
        </div>
      </div>
